...
<div id="dashboard">
	<main id="primary" class="container d-flex">
		<aside id="sidebar" class="sidebar">
			<div class="side-logo"><img src="/themes/niyaysociety/css/login.css/img/no_img.png"></div>
			<div id="side-menu">
				<ul>
					<li><a href="">แบบร่างทั้งหมด</a></li>
					<li><a href="">เขียนเรื่องใหม่</a></li>
					<li><a href="">เพิ่มตอนใหม่</a></li>
				</ul>
			</div>
		...
		<div id="content" class="content-area">
			...
			<div id="draft-panel" class="panel">
				<header class="panel-header">แบบร่างทั้งหมด</header>
				<div class="panel-body">
			...
			<div id="add-panel" class="panel">
				<header class="panel-header">เพิ่มเนื้อหา</header>
				<div class="panel-body">
					<div class="inner">
						<div class="desc">กรุณาเลือกประเภทของเนื้อหาที่คุณต้องการเพิ่ม ?</div>
						<ul>
							<li><a class="btn-gradient--2" href="#"><span class="icon-pen">เพิ่มเรื่องใหม่</span></a></li>
							<li><a class="btn-gradient--2" href="#"><span class="icon-doc">เพิ่มตอนใหม่</span></a></li>
						</ul>
					</div>	
				</div>
			</div>
