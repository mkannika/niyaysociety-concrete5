<?php
	...
	if($ak_img_url == ''){
		$ak_img_url = $this->getThemePath() . '/img/niyaysociety_thumb_share.png';
	}
?>
<!-- SEO content -->
...
<meta property="og:image:secure_url" content="<?php echo $this->getThemePath(); ?>/themes/niyaysociety/img/niyaysociety_thumb_share.png" />
