...
?>
<div class="ccm-ui">
<table class="ccm-ui bordered-table zebra-striped">
	<thead><tr><th><?php   echo t('Topic Name');?></th><th><?php   echo t('Author');?></th><th><?php   echo t('Date');?></th></tr></thead><tbody>
	...
	<?php   foreach ($pages as $page):
		...
		<td>
			<?php   echo $page->getVersionObject()->getVersionAuthorUserName(); ?>
		</td>
		<td>
			<?php   echo $page->getCollectionDateAdded('F j, Y'); ?>
		</td></tr>
