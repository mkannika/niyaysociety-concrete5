<main id="primary" class="d-flex">
	<aside id="side-menu" class="sidebar">
		...
		<div class="side-logo"><a href="./"><img src="/themes/niyaysociety2020/img/logo_inverse.png" alt="Niyay Society"></a></div>
		<div class="widget">
			<ul id="side-composer-menu">
				<li><a class="active" href="/index.php/dashboard/composer/write/">หน้า Dashboard</a></li>
				<li><a href="/index.php/dashboard/composer/drafts/">แบบร่างทั้งหมด</a></li>
			</ul>
			<ul id="side-back-menu">
				<li><a class="icon-dash" href="/profile/view/">กลับไปหน้าของฉัน</a></li>
...
<?php } else { ?>
	...
	//echo Loader::helper('concrete/dashboard')->getDashboardPaneHeader($favorites = false);

	echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('เพิ่มเนื้อหา'), false, 'span10', true, array(""), false, false); ?>
